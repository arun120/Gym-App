...
public class FullscreenVideoView extends AppCompatActivity {
    ...
    VideoView video;
    ImageButton pause,tilt;
    Handler handler=new Handler();
    TextView duration,set_text;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar = (Toolbar) findViewById(R.id.full_toolbar);
        ...
        mContentView = findViewById(R.id.ful_video);
        // Set up the user interaction to manually show or hide the system UI.
        slider= (com.rey.material.widget.Slider) findViewById(R.id.seek1);
        ...
        pause= (ImageButton) findViewById(R.id.pause1);
        tilt= (ImageButton) findViewById(R.id.tilt);
        duration= (TextView) findViewById(R.id.duration);
        set_text= (TextView) findViewById(R.id.volume_text);
        video= (VideoView) findViewById(R.id.ful_video);
        int seek=getIntent().getExtras().getInt("seek");
        ...
        video.setOnPreparedListener(new MediaPlayer.OnPreparedListener() {
            ...
            public void onPrepared(MediaPlayer mp) {
                ...
                dur1 = String.format("%02d:%02d:%02d", TimeUnit.MILLISECONDS.toHours(vid_dur),
                ...
                update();
                slider.setValueRange(0, (int) TimeUnit.MILLISECONDS.toSeconds(vid_dur), true);
            }
        });
    ...
    public void update() {
        ...
        String dur = String.format("%02d:%02d:%02d", TimeUnit.MILLISECONDS.toHours(vid_dur),
                ...
                TimeUnit.MILLISECONDS.toSeconds(vid_dur) -
                        TimeUnit.MINUTES.toSeconds(TimeUnit.MILLISECONDS.toMinutes(vid_dur)));
        slider.setValue(time, false);
        String done=dur +'/'+dur1;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id==R.id.full_screen){
            Intent intent;//=new Intent(FullscreenVideoView.this,MainActivity.class);
